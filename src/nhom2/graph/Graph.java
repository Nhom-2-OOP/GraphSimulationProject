...
public interface Graph<V, E> {
	...
	// Tra ve collection gom cac canh noi lien voi v, v la outbound

	public Collection<Vertex<V>> adjVertexList(Vertex<V> v);
	// Tra ve collection gom cac dinh ke voi dinh v, v la outbound
	
	public Collection<Edge<E,V>> incidentEdgesReverse(Vertex<V> v);
	// Tra ve collection gom cac canh noi lien voi v, v la inbound
	
	public Collection<Vertex<V>> adjVertexListReverse(Vertex<V> v);
	// Tra ve collection gom cac dinh ke voi dinh v, v la inbound
...
//	public Edge<E, V> insertEdge(Vertex<V> u, Vertex<V> v, E edgeElement);
	...
	// Xoa canh khoi do thi
	
	public void deleteVertex(Vertex<V> v);
	// Xoa dinh khoi do thi
}
